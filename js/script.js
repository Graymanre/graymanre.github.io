        ...
        function() {
            ...
            e.forEach(e => {
                e.addEventListener("click", function() {
                    n.classList.add("is-visible"), setTimeout(() => {
                        document.querySelector('[aria-label="search-query"]').focus()
                    }, 250)
                })
            }), t.addEventListener("click", function() {
                n.classList.remove("is-visible"), document.querySelector('[aria-label="search-query"]').value = "", setTimeout(() => {
                    document.querySelector("#js-search-results-container").innerHTML = "", document.querySelector("#js-search-results-container").style.display = "none"
                }, 250)
            })
